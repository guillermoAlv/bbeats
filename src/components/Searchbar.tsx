...
} from "./plasmic/bbeats/PlasmicSearchbar";
...
function Searchbar({value, onChange, ...props}: SearchbarProps) {
  ...
  return <PlasmicSearchbar  type="search" onChange={onChange} value={value} {...props} />;
}
